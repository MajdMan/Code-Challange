...
namespace CodeChallenge
{
   ...
   /I also could have created classes with additional behavior, but I decided not to. 
   I just created this quick solution in a short period of time to solve the anagram. I tried to 
